...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                if (window.console && YourPersonalPhotographOrganiserBag.debug) {console.debug("displaySinglePhotos");}
                var buffer = "";
            ...
            {
                if (window.console && YourPersonalPhotographOrganiserBag.debug) {console.debug("displayMultiplePhotos");}
                var buffer = "";
                var photos = YourPersonalPhotographOrganiserBag.photos;
                var i = 0;
                var j = 0;
            ...
            {
                if (window.console && YourPersonalPhotographOrganiserBag.debug) {console.debug("showRootGalleries");}
